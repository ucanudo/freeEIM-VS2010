...
// 添加新的文件到列表，列表只能最大256
LRESULT CEIM02Dlg::EM_AddFileToList(WPARAM wParam, LPARAM lParam)
{
	for (int i=0; i<256; i++)
	{
		if (m_fInfo[i] == NULL)
...
LRESULT CEIM02Dlg::OnEM_DblClickTree(WPARAM wParam, LPARAM lParam)
{
...
// 对法给你发送文件
LRESULT CEIM02Dlg::EM_NewFile(WPARAM wParam, LPARAM lParam)
{
...
// 拒绝接收文件
LRESULT CEIM02Dlg::EM_RefuseFile(WPARAM wParam, LPARAM lParam)
{
	LPEM_FILEINFO pFinfo = (LPEM_FILEINFO)wParam;
	char *szIP = (char*)lParam;
...
// 对方同意接收文件
LRESULT CEIM02Dlg::EM_DestAcceptFile(WPARAM wParam, LPARAM lParam)
{
	//9999999999999
	LPEM_FILEINFO pFinfo = (LPEM_FILEINFO)wParam;
	char *szIP = (char*)lParam;
...
LRESULT CEIM02Dlg::EM_ReplyUDPMsg(WPARAM wParam, LPARAM lParam)
{
...
// 右键菜单 -> 刷新
LRESULT CEIM02Dlg::EM_Reflesh(WPARAM wParam, LPARAM lParam)
{
...
// 右键菜单 -> 群发
LRESULT CEIM02Dlg::EM_SendAll(WPARAM wParam, LPARAM lParam)
{
...
// 右键菜单 -> 属性
LRESULT CEIM02Dlg::EM_EMProperty(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CEIM02Dlg::EM_UserLogout(WPARAM wParam, LPARAM lParam)
{
	char *szIP = (char*)wParam;
//	MessageBox(szIP);
//	_User_DeleteUser();
...
// 删除文件列表中wParam指定的文件
// 回复对方，我拒绝接收他的文件
LRESULT CEIM02Dlg::EM_DeleteFileFromList(WPARAM wParam, LPARAM lParam)
{
	// 回复对方，我拒绝接收他的文件
	EM_FILEINFO finfo;
...
// 开始下载wParam指定的文件
LRESULT CEIM02Dlg::EM_DownloadFile(WPARAM wParam, LPARAM lParam)
{
	for (int i=0; i<256; i++)
	{
		if (m_fInfo[i] != NULL)
...
LRESULT CEIM02Dlg::FileComming(WPARAM wParam, LPARAM lParam)
{
...
// 文件发送完毕
LRESULT CEIM02Dlg::EM_FileSendCompleted(WPARAM wParam, LPARAM lParam)
{
	return TRUE;
}
...
LRESULT CEIM02Dlg::EM_Voice_CancelIncome(WPARAM wParam, LPARAM lParam)
{
...
// 对方接受语音对话请求
LRESULT CEIM02Dlg::EM_Voice_DestAcceptChat(WPARAM wParam, LPARAM lParam)
{
	char *szIP = (char*)lParam;
...
LRESULT CEIM02Dlg::EM_Voice_DoNotAcceptChat(WPARAM wParam, LPARAM lParam)
{
	int nValue = (int)wParam;
...
// 对方向你发送语音对话请求
LRESULT CEIM02Dlg::EM_Voice_Income(WPARAM wParam, LPARAM lParam)
{
	char *szIP = (char*)lParam;
...
// 查看与对方的历史记录
LRESULT CEIM02Dlg::EM_ViewHistory(WPARAM wParam, LPARAM lParam)
{
...
// 对方请求窗口抖动
LRESULT CEIM02Dlg::EM_ShakeWindow(WPARAM wParam, LPARAM lParam)
{
	char *szIP = (char*)lParam;
...
{
	AfxMessageBox(_T("_User_UserUpdate"));
...
// 对方用户修改部门名称
LRESULT CEIM02Dlg::_Dest_User_Update(WPARAM wParam, LPARAM lParam)
{
	DWORD dwMsg = wParam;

...
protected:
	...
	afx_msg LRESULT EM_RefuseFile(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT EM_DestAcceptFile(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT EM_DeleteFileFromList(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT EM_ReplyUDPMsg(WPARAM wParam, LPARAM lParam);
	...
	afx_msg LRESULT OnEM_DblClickTree(WPARAM wParam, LPARAM lParam);
	afx_msg void OnQuiteim();
//	afx_msg void EM_OnAutorun();
	afx_msg void OnEndSession(BOOL bEnding);
	afx_msg LRESULT EM_Reflesh(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT EM_UserLogout(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT EM_SendAll(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT EM_EMProperty(WPARAM wParam, LPARAM lParam);
	...
	afx_msg LRESULT _Dest_User_Update(WPARAM wParam, LPARAM lParam);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};

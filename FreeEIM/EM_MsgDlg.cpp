...
LRESULT EM_MsgDlg::OnUpdateDlg(WPARAM wParam, LPARAM lParam)
{
...
// 拒绝接受对方语音对话
LRESULT EM_MsgDlg::Voice_OnDoNotChat(WPARAM wParam, LPARAM lParam)
{
	if (NULL == m_pRecvChat)
		return FALSE;
...
// 接受对方语音对话请求
LRESULT EM_MsgDlg::Voice_SrcAcceptChat(WPARAM wParam, LPARAM lParam)
{
	// 向对方发送同意语音对话的消息
	EM_DATA data;
...
// 取消向对方请求语音对话
LRESULT EM_MsgDlg::Voice_CancelRequest(WPARAM wParam, LPARAM lParam)
{
	int nValue = wParam;
